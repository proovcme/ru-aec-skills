...
44 скилла для помощи ИИ-агенту в архитектурно-строительном и инженерном проектировании в Российской Федерации: нормативная основа, исходные данные, расчётные процессы, BIM-координация, проверка и выпуск документации.
...
```text
$skill-installer Установи все 44 скилла из репозитория
...
2. В своём проекте создайте `.agents/skills` и скопируйте туда **все 44 папки с `SKILL.md`**, включая их содержимое. Не копируйте `.git`. Перед заменой существующих одноимённых папок сохраните их отдельно и сравните изменения.
...
Предложения и исправления приветствуются. Порядок подготовки изменения, проверки нормативного основания и добавления нового скилла — в [CONTRIBUTING.md](CONTRIBUTING.md).
